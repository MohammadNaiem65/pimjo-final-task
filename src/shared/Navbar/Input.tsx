...
export default function Input({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        "relative flex w-56 items-center justify-between rounded-xl border border-(--color-border) py-2 pr-2.5 pl-4",
        className,
      )}
    >
      ...
      <input
        ...
        className="absolute inset-0 rounded-xl border border-(--color-border) py-2 pr-16 pl-12 outline-(--color-border) focus-visible:outline-2"
      />
